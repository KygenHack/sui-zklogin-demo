...
module liquid_staking::liquid_staking {
    ...
    fun test_create_lst_info() {
        ...
        let mut tc = test_scenario::begin(user);
        {
            ...
            set_up_sui_system_state(vector[@0x1, @0x2, @0x3,@0x7ddf1444a19b6ddb0eaddd98150100894f1cd04068769d546c06962e77532f28,@0xcc3e7b13c6e47b69ea390e0eae0ec0cbd79b4377e90af5bc08ee4e6ec9bdb637]);
        ...
        tc.next_tx(user);
        {
		    ...
		    //AlphaFi Validator
		    val_weight.insert(@0x7ddf1444a19b6ddb0eaddd98150100894f1cd04068769d546c06962e77532f28,90);

		    //Triton Validator
		    val_weight.insert(@0xcc3e7b13c6e47b69ea390e0eae0ec0cbd79b4377e90af5bc08ee4e6ec9bdb637,10);
